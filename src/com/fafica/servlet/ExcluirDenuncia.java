...
/**
 * Servlet implementation class ExcluirDenuncia
 */
@WebServlet("/ExcluirDenuncia")
public class ExcluirDenuncia extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ExcluirDenuncia() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		RepositorioDenuncia repositorio = new RepositorioDenuncia();
